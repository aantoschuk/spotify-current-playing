...
export default async function (req: VercelRequest, res: VercelResponse) {
  ...
  let svgContent = `<svg width="400" height="100" viewBox="0 0 400 100" xmlns="http://www.w3.org/2000/svg">
    <!-- Background -->
    <rect width="400" height="100" rx="10" fill="black"/>
    
    <!-- Not Active Message -->
    <text x="50%" y="50%" fill="white" font-size="18" font-family="Arial" text-anchor="middle" alignment-baseline="middle">
        Spotify Not Active
    </text>
</svg>
`;
...
<svg width="400" height="100" viewBox="0 0 400 100" xmlns="http://www.w3.org/2000/svg">
    ...
    ${
      isPlaying
        ? `
            <!-- Album Art -->
            <image x="10" y="10" width="80" height="80" href="${coverImg ?? null}" rx="5" />
